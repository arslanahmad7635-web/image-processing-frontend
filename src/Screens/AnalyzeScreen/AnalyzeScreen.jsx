...
function AnalyzeScreen() {
    ...
    async function detectEdges(image_Id) {
        ...
        setSelectedOption('Under Process');
    ...
    <section className={`w-full h-screen flex items-center ${selectedOption == '' ? 'justify-center' : 'justify-center'} overflow-hidden max-md:flex-col`}>
        ...
        {
            selectedOption == 'Edge Detection' ? (

                <AnalysisResults response={receivedResponse} option={selectedOption} />
                
            ) : selectedOption == 'Channel Analysis' ? (
