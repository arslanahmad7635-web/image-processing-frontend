...
function Navbar() {
  ...
  return (
    ...
    <nav
      className='w-full h-20 flex justify-center items-center bg-rgb(52,103,235) bg-blue-900'>
        ...
        <div className='w-1/4 h-full flex items-center justify-center font-poppins font-medium text-lg text-white'>
            <Link to={"/user-login"} className=' px-7 py-2  flex items-center justify-center rounded-sm bg-blue-900 hover:bg-white transition-colors duration-300 border border-transparent hover:border-white hover:text-black hover:border-black' >Join Us</Link>
        </div>
    </nav>
  )
